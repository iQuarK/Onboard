class CompaniesController < ApplicationController
  ...
  def company_params
    params.require(:company).permit(:name, :subdomain, :description, :industry, :location, :website, :benefits, :logo, :completed, :temp_logo_id, :background_colour, :header_colour)
  end
